...
<body>
    ...
    <div class="main-container">
        ...
        <div class="content-area<?php echo ($page === 'home') ? ' content-home' : ''; ?>">
    ...
    <div class="chatbot-container" aria-live="polite" aria-label="Chat assistant">
        <button class="chatbot-toggle" id="chatbotToggle" aria-label="Open chat" aria-controls="chatbotWindow" aria-expanded="false">
            <i class="fas fa-comments" aria-hidden="true"></i>
        </button>
        <div class="chatbot-window" id="chatbotWindow" role="dialog" aria-modal="true" aria-labelledby="chatbotTitle">
            <div class="chatbot-header">
                <div style="display:flex; align-items:center; gap:10px;">
                    <span style="width:34px;height:34px;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;background: var(--primary-gradient); color:#fff;"><i class="fas fa-feather"></i></span>
                    <div>
            ...
            <div class="chatbot-input">
                <button class="input-action" id="chatbotPlus" type="button" title="More options" aria-label="More options"><i class="fas fa-plus"></i></button>
                <input type="text" id="chatbotInput" placeholder="Chat here.." aria-label="Message input">
                <button class="input-action" id="chatbotVoice" type="button" title="Voice" aria-label="Voice input"><i class="fas fa-microphone"></i></button>
                <button class="input-action send" id="sendMessage" type="button" aria-label="Send message"><i class="fas fa-paper-plane" aria-hidden="true"></i></button>
            </div>
        </div>
    </div>
